...
$conn->query("UPDATE pesanan SET status_pesanan = 'berhasil' WHERE pesanan_id = $id");

// Redirect
header("Location: ../admin/pesanan.php?msg=Pesanan dengan kode token $token berhasil dikonfirmasi&type=success");
exit;
