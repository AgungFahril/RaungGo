...
.admin-card{background:#fff;border-radius:12px;padding:25px;box-shadow:0 4px 15px rgba(0,0,0,0.08);margin-bottom:20px}
.admin-card h2{color:#2e7d32;font-size:20px;margin-bottom:20px;display:flex;align-items:center;gap:10px}
    ...
    <div class="main">
        ...
        <div class="container-fluid mt-3">
            <!-- <div class="d-flex justify-content-between align-items-center mb-4">
                <h3 class="fw-bold text-success"><i class="fas fa-user-shield"></i> Manajemen Admin</h3>
            </div> -->
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-secondary" style="font-size:12px;padding:5px 10px" onclick="editAdmin(<?php echo $row['id']; ?>)"><i class="fas fa-edit"></i></button>
                                        <?php if ($row['id'] != $admin_id): ?>
                                        <button class="btn btn-danger" style="font-size:12px;padding:5px 10px" onclick="deleteAdmin(<?php echo $row['id']; ?>)"><i class="fas fa-trash"></i></button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                    ...
                    <div style="margin-top:30px">
                        ...
                        <form method="POST" action="#" onsubmit="updateMyProfile(event)">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="myNama" required>
                            </div>
                            <div class="form-group">
                                <label>Email</label>
            ...
            <div id="activity_log" class="tab-content <?php echo ($tab == 'activity_log') ? 'active' : ''; ?>">
                <div class="admin-card">
                    ...
                    <div class="form-group" style="max-width:300px">
                        ...
                        <button class="btn btn-primary mt-2" onclick="filterLog()"><i class="fas fa-filter"></i> Filter</button>
                    </div>
                    ...
                    <button class="btn btn-secondary mt-3" style="width:100%"><i class="fas fa-download"></i> Export Activity Log</button>
                </div>
            </div>
            ...
            <div id="user_management" class="tab-content <?php echo ($tab == 'user_management') ? 'active' : ''; ?>">
                <div class="admin-card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="searchPendaki" placeholder="Masukkan nama atau email pendaki...">
                    </div>
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo date('d-m-Y', strtotime($row['tanggal_daftar'])); ?></td>
                                    <td>
                                        <button class="btn btn-secondary" style="font-size:12px;padding:5px 10px" onclick="lockAccount(<?php echo $row['id']; ?>)"><i class="fas fa-lock"></i> Kunci</button>
                                        <button class="btn btn-success" style="font-size:12px;padding:5px 10px" onclick="resetPassword(<?php echo $row['id']; ?>)"><i class="fas fa-key"></i> Reset Pass</button>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                            </tbody>
                            ...
                            <table class="data-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-secondary" style="font-size:12px;padding:5px 10px"><i class="fas fa-download"></i> Download</button>
                                            <button class="btn btn-danger" style="font-size:12px;padding:5px 10px"><i class="fas fa-trash"></i> Hapus</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="admin-card">
                    ...
                    <form method="POST" action="#" onsubmit="saveSettings(event)">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="Gunung Raung Booking System" required>
                        </div>
                        <div class="form-group">
                            <label>Email Sistem</label>
                            <input type="email" class="form-control" value="admin@gungraung.com" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3">Jl. Contoh No. 123, Kota, Indonesia</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="emailNotif">Aktifkan Email Notifikasi</label>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div style="margin-top:30px;padding:15px;background:#e3f2fd;border-radius:8px;border-left:4px solid #1976d2">
                        ...
                        <button class="btn btn-danger mt-2" onclick="confirmClearCache()"><i class="fas fa-trash"></i> Clear Cache</button>
                        <button class="btn btn-danger mt-2 ms-2" onclick="confirmResetSystem()"><i class="fas fa-exclamation-triangle"></i> Reset Sistem</button>
                    </div>
                </div>
            </div>
...
function lockAccount(id) {
    if (confirm('Akun pendaki akan dikunci dan tidak bisa login. Lanjutkan?')) {
        alert('Akun pendaki berhasil dikunci!');
    }
}

function resetPassword(id) {
    if (confirm('Password akan direset ke password default. Lanjutkan?')) {
...
function confirmClearCache() {
    if (confirm('Semua cache akan dihapus. Lanjutkan?')) {
        alert('Cache berhasil dihapus!');
    }
}

function confirmResetSystem() {
    if (confirm('HATI-HATI! Ini akan mereset seluruh sistem. Yakin ingin lanjut?')) {
